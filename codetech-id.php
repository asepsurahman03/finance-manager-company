...
$company_filter = "Codetech.id"; // Hanya menampilkan transaksi dari Codetech.id
...
// Query dasar hanya untuk Codetech.id
...
// Data bulanan hanya untuk Codetech.id
try {
...
<head>
    ...
    <title>Pendapatan & Pengeluaran Codetech.id</title>
    </head>
        ...
        <div class="flex flex-col lg:flex-row h-full lg:h-screen">
            ...
            <!-- Main Content -->
             <div class="flex-1 p-4 md:p-6 bg-gray-100">
                <h1 class="text-3xl font-bold mb-6">Pendapatan & Pengeluaran Codetech.id</h1>

            <!-- Filter -->
            <div class="mb-6 flex flex-wrap gap-4">
                <a href="codetech-id.php" class="px-6 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition duration-300">Semua</a>
...
<script>
    ...
    function printTransactions() {
        ...
        const reportTitle = `    <h3 style="text-align: center; font-size: 1.5em; font-weight: bold; margin-bottom: 15px;">Laporan Pendapatan & Pengeluaran Codetecth.id - Pada Bulan ${monthName} ${year}</h3>`;
